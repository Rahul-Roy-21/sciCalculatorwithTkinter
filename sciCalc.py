...
import tkinter.font
import math, random
# provides the Font class for creating and using named fonts.

calc_root = Tk()
calc_root.iconphoto(False, PhotoImage(file ="favicon.png"))
...
#     cur = input.get()
#     if cur_operator[0] and not len(second):
#         equation.set(num)
#         second = num 
#         print(cur_operator, first, second)
#         return
...
#     print(cur_operator, first, second)
#     equation.set(cur+num)

# def operate(op):
#     global first
#     global second
#     global cur_operator
#     cur_operator = (True, op)
#     print(cur_operator, first, second)
...
#         if op == 'r':
#             if cur_operator[0]:
#                 second = str(float(second)**-1)
#                 equation.set(second)
#             else:
#                 first = str(float(first)**-1)
#                 equation.set(first)

#         elif op == '√':
#             if cur_operator[0]:
#                 second = str(float(second)**0.5)
#                 equation.set(second)
#             else:
#                 first = str(float(first)**0.5)
#                 equation.set(first)

#         elif op == 'n':
#             if cur_operator[0]:
#                 second = str(math.log(float(second)))
#                 equation.set(second)
#             else:
#                 first = str(math.log(float(first)))
#                 equation.set(first)

#         elif op == 'g':
#             if cur_operator[0]:
#                 second = str(math.log10(float(second)))
#                 equation.set(second)
#             else:
#                 first = str(math.log10(float(first)))
#                 equation.set(first)
#     except:
#         equation.set("ERROR")
...
#     #print(first, second, eval(first+cur_operator[1]+second))
#     try:
#         if cur_operator[1] == '+':
#             cur = str(eval(first +'+'+ second)) 
#         elif cur_operator[1] == '-':
#             cur = str(eval(first +'-'+ second))
#         elif cur_operator[1] == '*':
#             cur = str(eval(first +'*'+ second))
...
#             cur = str(eval(first +'/'+ second))
#         elif cur_operator[1] == '^':
#             cur = str(float(first)**float(second))
...
class Calc():
    def __init__(self):
        ...
        self.isTrue_2nd, self.isdegree, self.decimalclicked = False, True, False 
    ...
    def trig_log_root_click(self,clicked):
        ...
        try:
            if clicked == 'g':
                cur = str(math.log10(float(cur)))
            elif clicked == 'n':
                cur = str(math.log(float(cur)))
            elif clicked == 'r':
    ...
    def deg_2nd_click(self, clicked):
        if clicked == 'deg':
            ...
            btn_power["padx"] = {True: 20, False: 24} [btn_power["padx"] == 24]
...
btn_reciprocal = Button(root, text="1/x", padx=21, pady=15,bd=4,bg="#eff1f4", font=myfont, command=lambda: c.rec_fact_click('r'))
btn_power = Button(root, text='x'+get_super('y'), padx=24, pady=15,bd=4,bg="#eff1f4", font=myfont, command=lambda: c.pow_pc_clicked('pow'))
